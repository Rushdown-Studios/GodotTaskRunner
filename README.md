...
Documentation is available in `Docs/`. See [README.md](./addons/TaskRunner/Docs/README.md) for a complete table of contents.
...
Explore practical examples in `Examples/`. See [README.md](./addons/TaskRunner/Examples/README.md) for details.
