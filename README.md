![Task Runner Icon](./addons/TaskRunner/icon.png)
...
![Task Runner QuickStart](./addons/TaskRunner/Docs/Images/TaskRunnerQuickstart.gif)
...
Documentation is available in `Docs/`. See [documentation](./addons/TaskRunner/Docs/README.md) for a complete table of contents.
...
Explore practical examples in `Examples/`. See [examples](./addons/TaskRunner/Examples/README.md) for details.
